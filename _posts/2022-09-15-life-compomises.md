...
_PS: the optimal point for people is rarely lying on one end of the curve. Which is also why I think extremism in any form is a bad way to simplify decisions. The best trade-off often lies somewhere in the middle._

[^1]: In real-life, the optimal choice depends on more criteria than these two. For simplification, criterias like fulfilment, ethics, family time, commuting time are not discussed in the example.