...
date: 2026-02-28
permalink: /posts/february-2026-update/
tags:
  - Entrepreneurship
  - Life
---
...
## The product
- **The AI shifts**: These are wild times to build a software product. Companies have woken up to the power of AI for coding and are using it to build their own internal tools. Startups have already made the leap, SMEs are testing the waters, and big corps are... well, they're still discussing the cloud migrations they planned ten years ago (I'm exaggerating, but only slightly 😅). It feels like the cards are being reshuffled, and we're right in the middle of it (and quite well positioned to benefit from it).
